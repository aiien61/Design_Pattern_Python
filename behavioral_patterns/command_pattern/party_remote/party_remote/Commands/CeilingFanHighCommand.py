...
class CeilingFanHighCommand(Command):
    ...
    def undo(self) -> None:
        ...
        if version.major == 3 and version.minor >= 10:
            ...
            if self.prev_speed == CeilingFan.Speed.HIGH.name: self.ceiling_fan.high()
            elif self.prev_speed == CeilingFan.Speed.MEDIUM.name: self.ceiling_fan.medium()
            elif self.prev_speed == CeilingFan.Speed.LOW.name: self.ceiling_fan.low()
            else: self.ceiling_fan.off()
